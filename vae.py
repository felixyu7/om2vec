...
from utils import PositionalEncoding, calculate_summary_stats, convert_absolute_times_to_log_intervals, imq_kernel_multi
...
class NT_VAE(pl.LightningModule):
    ...
    def _calculate_mmd_loss(self, z):
    ...
    def training_step(self, batch, batch_idx):
        ...
        self.log("train_mmd_loss", mmd_loss, batch_size=self.hparams.batch_size, sync_dist=True)
    ...
    def validation_step(self, batch, batch_idx):
        ...
        self.log("val_mmd_loss", mmd_loss, batch_size=self.hparams.batch_size, sync_dist=True)
    ...
    def test_step(self, batch, batch_idx):
        ...
        self.log("test_mmd_loss", mmd_loss, batch_size=self.hparams.batch_s, sync_dist=True)
